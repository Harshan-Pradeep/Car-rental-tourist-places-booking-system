...
import AllCars from '../Components/CarComponets/AllCars';
import AddNewCar from '../Components/CarComponets/AddNewCar';
import UpdateCar from '../Components/CarComponets/UpdateCar';
import DeleteCar from '../Components/CarComponets/DeleteCar';
...
import CarBookings from '../Components/CarComponets/CarBookings';
      ...
      <div style={styles.container}>
        <div style={styles.leftContainer}>
            <div style={styles.buttonContainer}>
                <p style={styles.adminTitle}>Car Booking Admin </p>
                <button style={styles.button} name='home' onClick={()=>handleOnClick("AllCars")}>All Vehicles</button>
                <button style={styles.button} name='add' onClick={()=>handleOnClick("AddNewCar")}>Add</button>
                <button style={styles.button} name='update' onClick={()=>handleOnClick("UpdateCar")}>Update</button>
                <button style={styles.button} name='delete' onClick={()=>handleOnClick("DeleteCar")}>Delete</button>
                <button style={styles.button} name='Bookings' onClick={()=>handleOnClick("CarBookings")}>Bookings</button>
            </div>
            <div style={styles.buttonContainer}>
        ...
        <div style={styles.rightContainer}>
            {component==="AllCars" && <AllCars/>}
            {component==="AddNewCar" && <AddNewCar/>}
            {component==="UpdateCar" && <UpdateCar/>}
            {component==="DeleteCar" && <DeleteCar/>}
            {component==="CarBookings" && <CarBookings/>}
